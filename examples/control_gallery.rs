...
mod menu {
    pub fn setup_bar(ui: &boing::Ui) {
        setup_file(ui);
        setup_edit(ui);
        setup_help(ui);
    }

    fn setup_file<'ui>(ui: &'ui boing::Ui) {
...
fn create_tab(ui: &boing::Ui) -> boing::Tab {
